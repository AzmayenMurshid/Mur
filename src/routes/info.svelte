...
<style>
    ...
    .heading {
        ...
        color: #05d9e8;
        text-shadow: 0px 0px 500px #dadcdd;
        margin-right: 30%;
        font-size: 150%;
        margin-bottom: 0;
        animation: fadeIn 7s cubic-bezier(0, 1.07, .72, 1.42);
    }
    @keyframes fadeIn {
        from {
            opacity: 0;
    ...
    .animatedTexts{
        animation: fadeAndScale 7s cubic-bezier(0, 1.07, .72, 1.42);
